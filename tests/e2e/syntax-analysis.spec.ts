...
test.describe("Syntax Analysis", () => {
  ...
  test.describe("Word Detection", () => {
    test("detects individual words correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The quick brown fox jumps over the lazy dog", {
          delay: 10,
        });
    ...
    test("handles punctuation correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("Hello, world! How are you?", { delay: 10 });
      await page.waitForTimeout(600);
    ...
    test("hyphenated words counted correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("well-known state-of-the-art", { delay: 10 });
      await page.waitForTimeout(600);
  ...
  test.describe("Syntax Categories", () => {
    ...
    test("identifies nouns correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The cat sat on the mat", { delay: 10 });
      await page.waitForTimeout(600);
    ...
    test("identifies verbs correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The dog runs and jumps quickly", { delay: 10 });
      await page.waitForTimeout(600);
    ...
    test("identifies adjectives correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The quick brown fox", { delay: 10 });
      await page.waitForTimeout(600);
    ...
    test("identifies articles correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The cat and a dog", { delay: 10 });
      await page.waitForTimeout(600);
    ...
    test("identifies prepositions correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The cat is on the mat under the table", {
          delay: 10,
        });
      await page.waitForTimeout(600);
    ...
    test("identifies conjunctions correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("cats and dogs but not birds", { delay: 10 });
      await page.waitForTimeout(600);
    ...
    test("identifies adverbs correctly", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The cat runs quickly and jumps gracefully", {
          delay: 10,
        });
      await page.waitForTimeout(600);
  ...
  test.describe("Syntax Highlighting", () => {
    ...
    test("highlighted words have different color than plain text", async ({
      page,
    }) => {
      await page.locator("textarea").click();
      await page
        .locator("textarea")
        .pressSequentially("The cat", { delay: 10 });
      await page.waitForTimeout(600);
      ...
      const theColor = await theSpan.evaluate(
        (el) => getComputedStyle(el).color,
      );
      const catColor = await catSpan.evaluate(
        (el) => getComputedStyle(el).color,
      );
    ...
    test("toggling category off removes highlighting", async ({ page }) => {
      ...
      const nounsCheckbox = panel
        .locator("text=Nouns")
        .locator("..")
        .locator(
          'input[type="checkbox"], button[role="checkbox"], [role="switch"]',
        )
        .first();
  ...
  test.describe("Breakdown Panel", () => {
    ...
    test("category rows show counts", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The quick brown fox jumps", { delay: 10 });
      await page.waitForTimeout(600);
  ...
  test.describe("Occurrence Counting", () => {
    ...
    test("word type counts reflect occurrences not unique types", async ({
      page,
    }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("the cat and the dog", { delay: 10 });
      ...
      const articlesRow = panel
        .locator("div.absolute")
        .filter({ has: page.locator('span.font-medium:has-text("Articles")') });
      const articlesCount = articlesRow.locator(".text-lg.tabular-nums");
      await expect(articlesCount).toHaveText("2");
    });

    test("syntax data replaces on each analysis - no stale words", async ({
      page,
    }) => {
      // Clear any existing content first
      await page.reload();
      ...
      const panel = page.locator('[data-testid="desktop-syntax-panel"]');
      const nounsRow = panel
        .locator("div.absolute")
        .filter({ has: page.getByText("Nouns", { exact: true }) });
    ...
    test("punctuation-attached adjectives stay highlighted and match counts", async ({
      page,
    }) => {
      await page.reload();
      await page.waitForSelector("textarea");
      ...
      const adjectivesRow = panel
        .locator("div.absolute")
        .filter({
          has: page.locator('span.font-medium:has-text("Adjectives")'),
        });
      ...
      const backdrop = page
        .locator("main")
        .locator("div.whitespace-pre-wrap.pointer-events-none")
        .first();
  ...
  test.describe("Edge Cases", () => {
    ...
    test("handles numbers in text", async ({ page }) => {
      ...
      await page
        .locator("textarea")
        .pressSequentially("The 3 cats and 5 dogs", { delay: 10 });
      await page.waitForTimeout(600);
