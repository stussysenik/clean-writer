...
var isTitleCase2 = (str) => new RegExp("^\\p{Lu}[\\p{Ll}'’]", "u").test(str);
...
var isCapital = (terms, i3) => {
  if (terms[i3].tags.has("ProperNoun") && isTitleCase4.test(terms[i3].text)) {
    return "Noun";
  }
  return null;
};
...
var pickTag = function(terms, i3, clues5, model5) {
  ...
  const beforeIndex = ((_a = terms[i3 - 1]) == null ? void 0 : _a.text) !== "also" ? i3 - 1 : Math.max(0, i3 - 2);
  const tagSet = model5.one.tagSet;
...
var titleCase4 = new RegExp("^\\p{Lu}[\\p{Ll}'’]", "u");
